...
> This is a reproducible simulation and decision-analysis project for ISR resource allocation, with a clear path toward optimization, autonomy evaluation, and experiment pipelines.
